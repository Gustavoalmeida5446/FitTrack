...
const tokenSynonyms: Record<string, string[]> = {
  abdutor: ['abductor'],
  abducao: ['abduction', 'abductor'],
  aducao: ['adduction', 'adductor'],
  adutor: ['adductor'],
  agachamento: ['squat'],
  barra: ['barbell'],
  barbell: ['barra'],
  ...
  peito: ['chest'],
  pulley: ['cable', 'pulldown'],
  pulldown: ['puxada', 'pulley'],
  puxada: ['pulldown', 'pulley'],
  remada: ['row'],
  row: ['remada'],
  rope: ['corda'],
  squat: ['agachamento'],
  supino: ['bench', 'press', 'chest'],
  tricep: ['triceps'],
  triceps: ['tricep'],
